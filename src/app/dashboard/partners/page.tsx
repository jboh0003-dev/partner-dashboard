...
import { AnimatedSection, FadeSurface } from "@/components/common/animated-section";
...
import {
  buildPartnersListHref,
  fetchPartnersListPage
} from "@/lib/partners/partners-list-query";
...
export default async function PartnersPage({
  ...
  const result = await fetchPartnersListPage(supabase, params);
  const {
    rows,
    totalCount,
    page,
        ...
        {partnersError ? (
          ...
          <>
            ...
            <ListPagination
              ...
              pageSize={pageSize}
              buildHref={(p) => buildPartnersListHref(params, p)}
            />
          </>
        )}
      </AnimatedSection>
