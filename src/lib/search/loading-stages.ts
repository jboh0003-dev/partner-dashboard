...
const BASE_STAGES: OkeLoadingStage[] = [
  { id: "analyze", label: "질문을 분석하고 있습니다." },
  { id: "classify", label: "조회 유형을 판단하고 있습니다." }
];

const DATA_STAGE: Record<string, OkeLoadingStage> = {
  partner: { id: "partner-db", label: "관련 데이터를 검색하고 있습니다." },
  filter: { id: "filter", label: "관련 데이터를 검색하고 있습니다." },
  extract: { id: "extract", label: "관련 데이터를 검색하고 있습니다." },
  policy: { id: "policy", label: "관련 데이터를 검색하고 있습니다." },
  document: { id: "document", label: "관련 데이터를 검색하고 있습니다." },
  event: { id: "event", label: "관련 데이터를 검색하고 있습니다." },
  knowledge: { id: "knowledge", label: "관련 데이터를 검색하고 있습니다." },
  training: { id: "training", label: "관련 데이터를 검색하고 있습니다." },
  asset: { id: "asset", label: "관련 데이터를 검색하고 있습니다." }
};
