...
const CARD_CLASS =
  "ui-enter-item flex h-full min-h-[9.25rem] flex-col rounded-xl border border-slate-300/90 bg-white p-5 shadow-sm transition hover:border-okestro-300 hover:ring-2 hover:ring-okestro-100";
